...
function ConverterJPG() {
    ...
    const allowedFormats = useMemo(() => ['png', 'webp', 'tiff', 'svg', 'avif', 'gif', 'jpeg'], []);
    ...
    const handleDrop = useCallback((e) => {
        ...
        if (file) {
            ...
            if (allowedFormats.includes(fileExtension)) {
                ...
                setError(`Invalid file format. Only ${allowedFormats.join(', ')} can be converted to JPG.`);
            }
        }
    }, [allowedFormats]);
    ...
    const onUpload = async () => {
        ...
        try {
            const response = await axiosInstance.post('images/convert/jpg', formData, {
    ...
    return (
        ...
        >
            <h2 className="text-5xl font-bold mb-10 text-gray-800">Convert images to JPG</h2>
            <p className="mb-6 text-gray-600">
                    ...
                    <span className="text-blue-600">PNG</span> to JPG format.
                    <br/>
    ...
    {selectedFile ? selectedFile.name : 'Drag and drop a file here, or click to select'}
            ...
            {downloadLink && (
                <div className="flex flex-col items-center mt-8">
                    ...
                    <a href={downloadLink} download="converted.jpg" className="bg-red-500 text-white py-3 px-6 rounded-lg text-2xl hover:bg-red-700 transition-colors duration-300 mt-4">
